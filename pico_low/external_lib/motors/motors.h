...
#define PWM_PIN_1 3     //Подключаем к GP2 - 4 ножка микроконтроллера
#define PWM_PIN_2 4     //Подключаем к GP3 - 5 ножка микроконтроллера
#define PWM_PIN_3 5     //Подключаем к GP4 - 6 ножка микроконтроллера
#define PWM_PIN_4 6     //Подключаем к GP5 - 7 ножка микроконтроллера
